...
//    && c < map.[i, j - 1]
//  // LEFT
//  | (i, j) when i = 0 && j > 0 && j < (map.GetLength(1) - 1) ->
//    c < map.[i + 1, j]
//    && c < map.[i, j + 1]
//    && c < map.[i, j - 1]
//  // Right
...
//    && c < map.[i, j - 1]
//  // Top
//  | (i, j) when i > 0 && i < (map.GetLength(0) - 1) && j = 0 ->
//    c < map.[i + 1, j]
//    && c < map.[i - 1, j]
//    && c < map.[i, j + 1]
//  // Bottom
...
//    && c < map.[i, j - 1]
//  // UpperLeft
//  | (i, j) when i = 0 && j = 0 -> c < map.[i + 1, j] && c < map.[i, j + 1]
//  // UpperRight
//  | (i, j) when i = (map.GetLength(0) - 1) && j = 0 -> c < map.[i - 1, j] && c < map.[i, j + 1]
//  // LowerLeft
//  | (i, j) when i = 0 && j = (map.GetLength(1) - 1) -> c < map.[i, j - 1] && c < map.[i + 1, j]
//  // LowerRight
//  | (i, j) when
//    i = (map.GetLength(0) - 1)
//    && j = (map.GetLength(1) - 1)
